module.exports = environments =>{
    ...
    Когда я Продавец, я, покупаю за  Ask, а продаю за Bid. Тогда мой риск - это цена входа минус минимальная
    цена выхода - то есть минимум из всех Bid. Чем ниже потенциальная цена выхода, тем выше мой риск.
    Когда я покупатель, я прокупаю за Bid, а продаю за Ask. Тогда мой риск - это максимальная потенциальная цена
