...
module.exports = InsertVirtualOrderContextFactory;

function InsertVirtualOrderContextFactory(){
    ...
    this.create = tableGatewayContext =>{
        ...
        const filePath = "C:/Users/yuryp/AppData/Roaming/MetaQuotes/Terminal/Common/Files/mt5.sqlite";
        const statements = tableGatewayContext.tables.reduce((acc, table)=>{
        ...
        return new SqliteActionContext(filePath, statements);
    };
}